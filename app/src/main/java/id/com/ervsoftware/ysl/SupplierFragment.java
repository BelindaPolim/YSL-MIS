...
public class SupplierFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        llPembelian = view.findViewById(R.id.layoutPembelian);
        llPembelian.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), PembelianActivity.class));
            }
        });
        llPembelian.setOnTouchListener(new View.OnTouchListener() {
            @Override
        ...
        llHutang = view.findViewById(R.id.layoutHutang);
        ...
        llHutang.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
